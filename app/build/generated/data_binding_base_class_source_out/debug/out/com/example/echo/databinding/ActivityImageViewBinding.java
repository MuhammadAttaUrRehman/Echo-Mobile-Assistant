...
public final class ActivityImageViewBinding implements ViewBinding {
  ...
  private ActivityImageViewBinding(@NonNull LinearLayout rootView, @NonNull Button btnClose,
      @NonNull ImageView ivFullScreenImage) {
  ...
  public static ActivityImageViewBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.ivFullScreenImage;
      ImageView ivFullScreenImage = ViewBindings.findChildViewById(rootView, id);
      if (ivFullScreenImage == null) {
        break missingId;
      }

      return new ActivityImageViewBinding((LinearLayout) rootView, btnClose, ivFullScreenImage);
    }
