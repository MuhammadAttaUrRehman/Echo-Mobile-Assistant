...
public final class ItemUserMessageBinding implements ViewBinding {
  ...
  private ItemUserMessageBinding(@NonNull CardView rootView, @NonNull TextView messageText,
  ...
  public static ItemUserMessageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemUserMessageBinding((CardView) rootView, messageText, timestampText);
    }
